...
# Función simple de normalización min-max
...
tau_largo_norm <- normalizar(tau_largo)
tau_corto_norm <- normalizar(tau_corto)

# --- CALCULAR DIFERENCIA ABSOLUTA DIRECTAMENTE ---
# Calculamos la diferencia absoluta píxel por píxel
diferencia_absoluta <- (tau_corto_norm - tau_largo_norm)
...
hist(diferencia_absoluta,
     breaks = 50,
     main = "Distribución de diferencias normalizadas",
...
# --- GUARDAR GRÁFICOS ---
# Histograma
png("E:/AUTOCORRELACION/tendencia/tendencia_10/h_tendencia_10_nor.png", 
...
ggsave("E:/AUTOCORRELACION/tendencia/tendencia_10/d_tendencia_10_nor.png", 
...
ggsave("E:/AUTOCORRELACION/tendencia/tendencia_10/hd_tendencia_10_nor.png", 
...
writeRaster(diferencia_absoluta, 
            "E:/AUTOCORRELACION/tendencia/tendencia_10/tendencia_10_nor.tif", 
            overwrite = TRUE)