...
ndvis <- brick("E:/INDICES/VI/NDVI_MAX/stack_2015_2024/ndvi_2015_2024.tif")  
...
writeRaster(
  tau_layer,
  filename  = "E:/INDICES/VI/NDVI_MAX/stack_2015_2024/kendall_2015_2024/tau_2015_2024.tif",
  format    = "GTiff",
  overwrite = TRUE,
  progress  = "text"
)
...
writeRaster(
  sl_layer_fixed,
  filename  = "E:/INDICES/VI/NDVI_MAX/stack_2015_2024/kendall_2015_2024/sl_2015_2024.tif",
  format    = "GTiff",
  overwrite = TRUE,
  progress  = "text"
)
...
writeRaster(
  kendall_result,
  filename  = "E:/INDICES/VI/NDVI_MAX/stack_2015_2024/kendall_2015_2024/complete_2015_2024.tif",
  format    = "GTiff",
  overwrite = TRUE,
  progress  = "text"
)
