...
setwd("E:/SEGMENTACION/VARIABLES/P/P_YEARLY/precipitacion_1984_2024/precipitacion_1984_2024_anual")
...
out_tmp <- "precipitacion_1984_2024_tmp.tif"
writeRaster(
  st,
  filename  = out_tmp,
  format    = "GTiff",
...
writeRaster(
  ndvis,
  filename  = "E:/SEGMENTACION/VARIABLES/P/P_YEARLY/precipitacion_1984_2024/precipitacion_1984_2024.tif",
  format    = "GTiff",
  overwrite = TRUE,
  progress  = "text"
)