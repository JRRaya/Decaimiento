...
setwd("E:/SEGMENTACION/VARIABLES/T/T_MAX_ANUAL/temperatura_1984_2024/temperatura_1984_2024_anual")
...
out_tmp <- "temperatura_1984_2024_tmp.tif"
writeRaster(
  st,
  filename  = out_tmp,
  format    = "GTiff",
...
writeRaster(
  ndvis,
  filename  = "E:/SEGMENTACION/VARIABLES/T/T_MAX_ANUAL/temperatura_1984_2024/temperatura_1984_2024.tif",
  format    = "GTiff",
  overwrite = TRUE,
  progress  = "text"
)
